...
/**
 * Theropod is a Java class containing the information, getters and setters of this specific type
...
public abstract class Theropod implements Dinosaur, Serializable {
    ...
    /**
     * Main constructor for the class. Instantiates a Theropod object and depending on user specification
     * it fills the variables.
     *
     * @param name       -> name of the dino
     * @param vegetarian -> if carnivore or not
     */
    public Theropod(String name, boolean vegetarian, String zone) {
        this.name = name;
    ...
    public String getType() {
        return "* Theropod: " + getSubType() + " named " + getName();
    }
