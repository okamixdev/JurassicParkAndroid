...
/**
 * Sauropod is a Java class containing the information, getters and setters of this specific type
...
public abstract class Sauropod implements Dinosaur, Serializable {
    ...
    /**
     * Main constructor for the class. Instantiates a Sauropod object and depending on user specification
     * it fills the variables.
     *
     * @param name       -> name of the dino
     * @param vegetarian -> if carnivore or not
     */
    public Sauropod(String name, boolean vegetarian, String zone) {
        this.name = name;
