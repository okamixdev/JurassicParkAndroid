...
/**
 * Stegosaur is a Java class containing the information, getters and setters of this specific type
...
public abstract class Stegosaur implements Dinosaur, Serializable {
    ...
    /**
     * Main constructor for the class. Instantiates a Stegosaur object and depending on user specification
     * it fills the variables.
     *
     * @param name       -> name of the dino
     * @param vegetarian -> if carnivore or not
     */
    public Stegosaur(String name, boolean vegetarian, String zone) {
        this.name = name;
    ...
    public String getType() {
        return "* Stegosaur: " + getSubType() + " named " + getName();
    }
